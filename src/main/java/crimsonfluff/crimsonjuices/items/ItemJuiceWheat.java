...
public class ItemJuiceWheat extends Item {
    public ItemJuiceWheat() {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new TranslationTextComponent("tip." + CrimsonJuices.MOD_ID + ".juice.wheat").mergeStyle(TextFormatting.YELLOW));
