...
public class ItemSugarWater extends Item {
    public ItemSugarWater() {
        super(new Properties()
                ...
                .food(new Food.Builder()
                        .hunger(4)
                        .saturation(0.75f)
                        .effect(()-> new EffectInstance(Effects.SPEED,1200, 0, false, true), 1f)
                        .build())
            );
        }
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new TranslationTextComponent("tip." + CrimsonJuices.MOD_ID + ".water.sugar").mergeStyle(TextFormatting.YELLOW));
