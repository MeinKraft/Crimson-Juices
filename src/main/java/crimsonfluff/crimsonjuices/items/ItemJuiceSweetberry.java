...
public class ItemJuiceSweetberry extends Item {
    public ItemJuiceSweetberry() {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new TranslationTextComponent("tip." + CrimsonJuices.MOD_ID + ".juice.sweetberry").mergeStyle(TextFormatting.YELLOW));
