...
public class ItemJuiceChorus extends Item {
    public ItemJuiceChorus() {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new TranslationTextComponent("tip." + CrimsonJuices.MOD_ID + ".juice.chorus").mergeStyle(TextFormatting.YELLOW));
